...
{
inline std::array<Bitboard, 64> m_whitePawnsAttacks; //< Precomputed pawn attacks for white pawns
inline std::array<Bitboard, 64> m_blackPawnsAttacks; //< Precomputed pawn attacks for black pawns
inline std::array<Bitboard, 64> m_knightAttacks; //< Precomputed knight attacks
inline std::array<Bitboard, 64> m_kingAttacks; //< Precomputed king attacks
inline std::array<std::array<Bitboard, 512>, 64> m_bishopAttacks; //< Precomputed bishop attacks ([square][occupancy])
inline std::array<std::array<Bitboard, 4096>, 64> m_rookAttacks; //< Precomputed rook attacks ([square][occupancy])

inline std::array<Bitboard, 64> m_bishopAttacksMasks;
inline std::array<Bitboard, 64> m_rookAttacksMasks;
